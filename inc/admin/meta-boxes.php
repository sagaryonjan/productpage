...
function productpage_add_custom_box()
{
    ...
    add_meta_box('page-layout', esc_html__('Select Layout', 'productpage'), 'productpage_layout_call', 'page', 'side', 'default');

    // Adding layout meta box for Post
    add_meta_box('post-layout', esc_html__('Select Layout', 'productpage'), 'productpage_layout_call', 'post', 'side', 'default');
}
...
function productpage_layout_call()
{
    global $productpage_page_specific_layout;
    productpage_meta_form($productpage_page_specific_layout);
}

/**
 * Displays metabox to for select layout option
 */
function productpage_meta_form($productpage_metabox_field)
{
    global $post;
    ...
    foreach ($productpage_metabox_field as $field) {
...
{
    global $productpage_page_specific_layout, $post;
