...
add_action('widgets_init', 'productpage_slider_register');

function productpage_slider_register()
{
    register_widget("productpage_slider");
}

class Productpage_Slider extends WP_Widget
{

    function __construct()
    {
        $widget_ops = array(
            'classname'      => 'productpage_slider',
            'description'    => esc_html__( ' Product Info ', 'productpage'));

        parent::__construct( 'productpage_slider', '&nbsp;' . __('&spades; TS: Slider ', 'productpage'), $widget_ops);
    }// end of construct.
